...
const Product = ({ product }) => {
  ...
  const [picColor, setPicColor] = useState("Black")
  console.log("pic color", picColor)
  return (
    <Layout>
      ...
      <section className="product-single">
        <div className="container">
          ...
          <div className="product-single__content">
            <Gallery images={product.images} picColor={picColor} />
            <Content product={product} setPicColor={setPicColor} picColor={picColor} />
          </div>
